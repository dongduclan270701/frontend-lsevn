...
const ModalChangeName = (props) => {
    ...
    const { getNewProjectName, getSelectCloseButton, ChooseChangeProjectName1, item, newName, page } = props
    ...
    const getProjectName = (e) => {
        ...
        if(e.target.value === ''){
            document.getElementById('update-name-project').style.opacity = 0.5
            document.getElementById('update-name-project').style.cursor = 'not-allowed'
        }else{
            document.getElementById('update-name-project').style.opacity = 1
            document.getElementById('update-name-project').style.cursor = 'pointer'
        }
    }
            ...
            <div ref={refOne} className="modal-dialog modal-lg modal-dialog-centered" role="document">
                <div className="modal-content" style={{ border: "1px solid #d3cfcf", borderRadius: "10px" }}>
                    ...
                    <div className="modal-footer">
                        ...
                        <a onClick={projectName ? getInputProjectName : getInputProjectName1} id='update-name-project' className="btn btn-primary ms-auto" data-bs-dismiss="modal">
                            Update
                        </a>
                    </div>
                </div>
